...
namespace TextAdventurer
{
    ...
    internal class Story
    {
        ...
        private Story(StoryDataContract storyData, List<SaveStateDataContract> saveStates, string saveStatesPath)
        {
            ...
            window = new Window();
            headerPanel = window.AddControl<Panel>(new Vector2Int(1, 1), new Vector2Int(0, 7));
            titleLabel = headerPanel.AddControl<ColoredLabel>(new Vector2Int(1, 0), new Vector2Int(0, 1));
            titleLabel.Text = storyData.Title;
            titleLabel.TextAlignment = ETextAlignment.TopCenter;
            authorNameLabel = headerPanel.AddControl<ColoredLabel>(new Vector2Int(1, 2), new Vector2Int(0, 1));
            authorNameLabel.Text = "Author: " + storyData.Author;
            authorNameLabel.TextAlignment = ETextAlignment.TopRight;
            licenseLabel = headerPanel.AddControl<ColoredLabel>(new Vector2Int(1, 4), new Vector2Int(0, 1));
            licenseLabel.Text = "License: " + storyData.License;
            mainMenuPanel = window.AddControl<Panel>(new Vector2Int(1, 7), Vector2Int.zero);
            mainMenuPanel.IsTopOpen = true;
            descriptionTextField = mainMenuPanel.AddControl<ColoredTextField>(new Vector2Int(1, 0), new Vector2Int(0, 1));
            descriptionTextField.Text = storyData.Description;
            gamePanel = window.AddControl<Panel>(new Vector2Int(1, 7), Vector2Int.zero);
            gamePanel.IsVisible = false;
            gamePanel.IsTopOpen = true;
            gameTextField = gamePanel.AddControl<ColoredTextField>(new Vector2Int(1, 0), new Vector2Int(0, 1));
            commandLinePanel = window.AddControl<Panel>(new Vector2Int(1, 0), new Vector2Int(0, 3));
            commandLinePanel.IsVisible = false;
            commandLinePanel.IsTopOpen = true;
            commandLineInputField = commandLinePanel.AddControl<InputField>(new Vector2Int(1, 0), new Vector2Int(0, 1));
            commandLineInputField.Hint = "...";
            mainMenu = mainMenuPanel.AddControl<Menu>(new Vector2Int(0, 0), Vector2Int.zero);
            mainMenu.IsVisible = false;
            mainMenu.Items = new string[] { "New game", "Load game (not implemented)", "Exit" };
            mainMenu.OnItemSelected += MainMenuItemSelectedEvent;
            pauseMenu = gamePanel.AddControl<Menu>(new Vector2Int(0, 0), Vector2Int.zero);
            pauseMenu.IsVisible = false;
            pauseMenu.Items = new string[] { "Resume game", "Save game (not implemented)", "Exit" };
            pauseMenu.OnItemSelected += PauseMenuItemSelectedEvent;
            loadSaveStateMenu = mainMenuPanel.AddControl<Menu>(new Vector2Int(1, 3), Vector2Int.zero);
            loadSaveStateMenu.IsVisible = false;
            loadSaveStateMenu.OnItemSelected += LoadSaveStateMenuItemSelectedEvent;
            saveSaveStateMenu = gamePanel.AddControl<Menu>(new Vector2Int(1, 3), Vector2Int.zero);
        ...
        {
            headerPanel.Size = new Vector2Int(size.X - 2, 7);
            titleLabel.Size = new Vector2Int(headerPanel.Size.X - 4, 1);
            authorNameLabel.Size = new Vector2Int(headerPanel.Size.X - 4, 1);
            licenseLabel.Size = new Vector2Int(headerPanel.Size.X - 4, 1);
            ...
            mainMenu.Size = new Vector2Int(gamePanel.Size.X - 2, gamePanel.Size.Y - 2);
            ...
            commandLinePanel.Position = new Vector2Int(1, size.Y - 4);
            commandLinePanel.Size = new Vector2Int(size.X - 2, 3);
            commandLineInputField.Size = new Vector2Int(commandLinePanel.Size.X - 4, 1);
            pauseMenu.Size = new Vector2Int(gamePanel.Size.X - 2, gamePanel.Size.Y - 2);
            if (dialog != null)
            {
